  ...
  return (
    <>
        ...
        <div className="flex flex-wrap w-full justify-evenly items-center gap-12">
          ...
          <div className="flex flex-col items-center gap-4 lg:w-[35%]">
            <h3 className="text-2xl text-white font-bold">
              "24/7 Postal are awesome to work with. They’re super supportive and
      ...
      <section className="px-2 md:px-8 lg:px-48 text-start lg:text-center my-6 pt-8">
        <div>
          <h2 className="text-4xl font-bold">How does 24/7 Postal work?</h2>
          <p className="mt-2">
            Fire up your kitchen for 24/7 Postal orders in a few easy steps
          </p>
        </div>
          ...
          <div className="flex flex-col items-center justify-center w-[65%] mx-auto">
            ...
            <details class="list-none w-full cursor-pointer shadow-lg ">
                <summary className="flex justify-between p-4 bg-white hover:bg-gray-100 border-b border-[#E5E5E5]" onClick={() => setAnswerAOpen(!answerAOpen)}>
                    <span className="">Do I need an FSA rating to join 24/7 Postal</span>
                    <button>
            ...
            <details class="list-none w-full cursor-pointer transition-all duration-500 ease-in-out shadow-lg">
                ...
                <div className="flex flex-col gap-2 text-[#707070] bg-white p-4 border-b border-[#E5E5E5]">
                  <p>We recommend using as many high quality images as possible on your 24/7 Postal menu. That's why we offer a professional photography service as part of some of our packages.</p>
                  <p>You can also upload your own imagery for your menu and restaurant 'shopfront' on 24/7 Postal. All images are reviewed against our photography guidelines.</p>
            ...
            <details class="list-none w-full cursor-pointer transition-all duration-500 ease-in-out shadow-lg">
                ...
                <div className="flex flex-col gap-2 text-[#707070] bg-white p-4 border-b border-[#E5E5E5]">
                  <p>You can choose to use 24/7 Postal's world-class logistics network or your own delivery drivers.</p>
